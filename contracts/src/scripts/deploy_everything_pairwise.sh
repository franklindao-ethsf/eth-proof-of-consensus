...
cast send \
  ...
  --private-key $OPTIMISM_PRIVATE_KEY \
  $DEPOSIT_OPTIMISM_ADDRESS \
  "addToken(uint8,uint16,uint16[],address[])" 1 $GOERLI_CHAIN_ID "[$GOERLI_CHAIN_ID,$GNOSIS_CHAIN_ID,$OPTIMISM_CHAIN_ID]" "[$USD_GOERLI_ADDRESS,$USD_GNOSIS_ADDRESS,$USD_POLYGON_ADDRESS]"
